...
export const PROJECTS = [
  {
    ...
    images: [
      cld('/assets/images/projects/avs-preview.webp'),
  ...
  },
  {
    ...
    images: [
      cld('/assets/images/projects/saveurs-preview.webp'),
      cld('/assets/images/projects/saveurs-responsive.webp'),
    ],
  ...
  },
  {
    ...
    images: [
      cld('/assets/images/projects/cnib-preview.webp'),
      cld('/assets/images/projects/cnib-responsive.webp'),
    ],
    ...
    description: "Plateforme d'apprentissage en ligne adaptée au contexte africain avec catalogue interactif, paiements mobiles KKiaPay, examens et délivrance d'attestations certifiées.",
    year: '2026',
