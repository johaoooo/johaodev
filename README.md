...
|---|---|---|---|---|---|---|---|
| 1 | **Agro Véto Services**<br>Santé animale, Provenderie & Excellence QHSE | <img src="./public/assets/images/projects/avs-responsive.webp" alt="Aperçu Agro Véto Services" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Vitrine unique 6 pôles, clinique 24/7 et commandes d'intrants | Next.js, React, Tailwind CSS, Vercel, Mobile Money | [avs-wine.vercel.app](https://avs-wine.vercel.app/) |
| 2 | **Saveurs d'Agojiés**<br>E-Boutique Gastronomique & Terroir Béninois | <img src="./public/assets/images/projects/saveurs-responsive.webp" alt="Aperçu Saveurs d'Agojiés" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | E-boutique rapide avec panier interactif et tunnel d'achat optimisé | React, Node.js, Vite, Tailwind CSS | [saveurs-d-agojies.vercel.app](https://saveurs-d-agojies.vercel.app/) |
| 3 | **CNIB Platform**<br>Plateforme E-learning & Certifications | <img src="./public/assets/images/projects/cnib-responsive.webp" alt="Aperçu CNIB Platform" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | E-learning adapté à l'Afrique avec paiements KKiaPay et attestations certifiées | Django REST, React, Vite, PostgreSQL, KKiaPay | [cnib-platform-c5ru.vercel.app](https://cnib-platform-c5ru.vercel.app/) |
